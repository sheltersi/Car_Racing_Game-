...
const walletList = ["CardWallet","LedgerNano","Daedalus","Trezor","Nami","GeroWallet","Flint","Typhon","Ellipal","AdaLite","Atomic","Guarda","NuFi","Yoroi","Exodus","GameChanger","WIMSCardano"];

const hardForksList = ["Byron","Shelly","Goguen","Basho","Voltaire","Mary","Alonzo","Vasil"];
...
const byronList = ["Daedalus","AdaLoveless","Yoroi","Federation"];
...
const maryList = ["NativeTokens","MultiAssets","TokenRegistry"];

const vasilList = ["ReferenceInputs","InlineDatum","ReferenceScripts","ExplicitCollateral","HydraIntegration","DiffusionPipelining","Concurrency","EnterpriseBlockchain"];


const school= ["Hope","forest-hill","Phoenix","bridge"];
...
function selectList(e)
{
	...
	switch(val)
	{
		...
		case "school" : listTypes = school; break;
